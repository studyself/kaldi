...
#####$decoder_word --cmd "$decode_cmd" --nj $nDcd $srcdir/graph_word $datadir/test $srcdir/decode_test_word || exit 1;
...
#####$decoder_morpheme --cmd "$decode_cmd" --nj $nDcdM $srcdir/graph_morpheme_s data/graph_morpheme_s/lang/G.fst data/graph_morpheme/lang/G.fst \
#####  $datadir/testM $srcdir/decode_test_morpheme || exit 1;
...
$decoder_word --cmd "$decode_cmd" --nj $nDcdM $srcdir/graph_morpheme_s $datadir/testM $srcdir/decode_test_morpheme_1stPass || exit 1;
...
#####$decoder_word --cmd "$decode_cmd" --nj $nDcdMW $srcdir/graph_morpheme $datadir/test $srcdir/decode_test_morpheme_whole || exit 1;
#####
