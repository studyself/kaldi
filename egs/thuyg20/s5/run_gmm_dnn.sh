...
sleep 1s
######triphone
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 10000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_10k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 12000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_12k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 14000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_14k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 16000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_16k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 18000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_18k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 20000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_20k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 22000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_22k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 30000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_30k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" 2000 40000 data/mfcc/train data/lang exp/mono_ali exp/tri1_2k_40k || exit 1;

#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 10000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_10k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 12000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_12k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 14000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_14k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 16000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_16k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 18000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_18k || exit 1;
#
steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_20k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 22000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_22k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 30000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_30k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 40000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_40k || exit 1;

#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 32000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_32k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 34000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_34k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 36000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_36k || exit 1;
#
#steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4000 20000 4000 38000 data/mfcc/train data/lang exp/mono_ali exp/tri1_4k_38k || exit 1;
...
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 15000 data/mfcc/train data/lang exp/tri1_ali_2k_10k exp/tri2b_2.5k_15k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 19000 data/mfcc/train data/lang exp/tri1_ali_2k_12k exp/tri2b_2.5k_19k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 23000 data/mfcc/train data/lang exp/tri1_ali_2k_14k exp/tri2b_2.5k_23k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 27000 data/mfcc/train data/lang exp/tri1_ali_2k_16k exp/tri2b_2.5k_27k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 31000 data/mfcc/train data/lang exp/tri1_ali_2k_18k exp/tri2b_2.5k_31k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 35000 data/mfcc/train data/lang exp/tri1_ali_2k_20k exp/tri2b_2.5k_35k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 39000 data/mfcc/train data/lang exp/tri1_ali_2k_22k exp/tri2b_2.5k_39k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 44000 data/mfcc/train data/lang exp/tri1_ali_2k_30k exp/tri2b_2.5k_44k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" 2500 49000 data/mfcc/train data/lang exp/tri1_ali_2k_30k exp/tri2b_2.5k_49k
#

#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 15000 data/mfcc/train data/lang exp/tri1_ali_4k_10k exp/tri2b_4.5k_15k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 19000 data/mfcc/train data/lang exp/tri1_ali_4k_12k exp/tri2b_4.5k_19k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 23000 data/mfcc/train data/lang exp/tri1_ali_4k_14k exp/tri2b_4.5k_23k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 27000 data/mfcc/train data/lang exp/tri1_ali_4k_16k exp/tri2b_4.5k_27k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 31000 data/mfcc/train data/lang exp/tri1_ali_4k_18k exp/tri2b_4.5k_31k
#
steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 35000 data/mfcc/train data/lang exp/tri1_ali_4k_20k exp/tri2b_4.5k_35k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 39000 data/mfcc/train data/lang exp/tri1_ali_4k_22k exp/tri2b_4.5k_39k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 44000 data/mfcc/train data/lang exp/tri1_ali_4k_30k exp/tri2b_4.5k_44k
#
#steps/train_lda_mllt.sh --cmd "$train_cmd" --splice-opts "--left-context=3 --right-context=3" --num-iters 75 --realign-iters "10 20 30 40 50 60 70" 4500 49000 data/mfcc/train data/lang exp/tri1_ali_4k_30k exp/tri2b_4.5k_49k
#####
#test tri2b model
...
#
#local/nnet/run_dnn_speedup.sh --stage 0  --nTrn $nTrn --nDcd $nDcd --nDcdM $nDcdM --nDcdMW $nDcdMW  exp/tri2b_4.5k_35k exp/tri2b_4.5k_35k_ali exp/tri2b_4.5k_35k_ali_cv || exit 1;
#fi
#
######echo "*****************************************************************************************************************************"
