...
bool q_DecodeUtterance(LatticeBiglmFasterDecoder &decoder, // not const but is really an input.
...
//  LatticeFasterDecoderConfig config;
   ...
   /// VectorFst<StdArc> *old_lm_fst = fst::ReadFstKaldi(old_lm_fst_rxfilename);
...
*/          	
          if (q_DecodeUtterance(decoder, decodable, trans_model, word_syms,
...
*/        	
        if (q_DecodeUtterance(decoder, decodable, trans_model, word_syms, utt,
